...
function civiledger_civicrm_navigationMenu(&$menu) {
  $civiledgerItems = [
    ...
    [
      'attributes' => [
        'label'      => ts('Dashboards'),
        'name'       => 'civiledger_group_dashboards',
        'url'        => NULL,
    ...
    [
      'attributes' => [
        'label'      => ts('Integrity Checks'),
        'name'       => 'civiledger_group_integrity',
        'url'        => NULL,
        'icon'       => 'crm-i fa-shield',
        'permission' => 'administer CiviCRM',
        'operator'   => NULL,
        'separator'  => NULL,
        'active'     => 1,
    ...
    // ── Group: Accounts & Financials ──────────────────────────────────────
    [
      'attributes' => [
        'label'      => ts('Accounts & Financials'),
        'name'       => 'civiledger_group_accounts',
        'url'        => NULL,
    ...
    // ── Group: Recurring & Donors ─────────────────────────────────────────
    [
      'attributes' => [
        'label'      => ts('Recurring & Donors'),
        'name'       => 'civiledger_group_recurring',
        'url'        => NULL,
    ...
    [
      'attributes' => [
        'label'      => ts('Audit & Period'),
        'name'       => 'civiledger_group_audit',
        'url'        => NULL,
