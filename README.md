...
├── civiledger.php                        Main file: hooks, navigation menu
│
├── CRM/Civiledger/
│   ├── BAO/
│   │   ├── AccountBalance.php            Feature 4: balance queries
│   │   ├── AccountCorrection.php         Feature 6: reversal logic
│   │   ├── AuditTrail.php                Feature 3: trail assembly
│   │   ├── ChainRepair.php               Feature 2: repair logic
│   │   ├── IntegrityChecker.php          Feature 1: integrity SQL
│   │   ├── MismatchDetector.php          Feature 5: mismatch SQL
│   │   ├── RepairTool.php                Feature 2: repair orchestrator
│   │   └── Utils.php                     Shared helpers
│   │
│   ├── Page/
│   │   ├── AccountBalance.php            Feature 4 route handler
│   │   ├── AccountCorrection.php         Feature 6 route handler
│   │   ├── Ajax.php                      AJAX endpoint (repair, search)
│   │   ├── AuditTrail.php                Feature 3 route handler
│   │   ├── Dashboard.php                 Main dashboard
│   │   ├── IntegrityChecker.php          Feature 1 route handler
│   │   ├── MismatchDetector.php          Feature 5 route handler
│   │   └── RepairTool.php                Feature 2 route handler
│   │
│   └── Form/
│       ├── AccountCorrection.php         Feature 6 QuickForm
│       ├── ChainRepair.php               Feature 2 QuickForm
│       ├── IntegrityCheck.php            Feature 1 filter form
│       └── MismatchDetector.php          Feature 5 filter form
│
├── templates/CRM/Civiledger/
│   ├── Page/
│   │   ├── AccountBalance.tpl            Feature 4 template
│   │   ├── AccountCorrection.tpl         Feature 6 template
│   │   ├── AuditTrail.tpl                Feature 3 template
│   │   ├── Dashboard.tpl                 Dashboard template
│   │   ├── IntegrityChecker.tpl          Feature 1 template
│   │   ├── MismatchDetector.tpl          Feature 5 template
│   │   └── RepairTool.tpl                Feature 2 template
│   └── Form/
│       ├── AccountCorrection.tpl
│       ├── ChainRepair.tpl
│       ├── IntegrityCheck.tpl
│       └── MismatchDetector.tpl
│
├── css/
│   └── civiledger.css                    Full responsive stylesheet
│
├── js/
│   └── civiledger.js                     AJAX, repair log, correction preview
│
├── xml/Menu/
│   └── civiledger.xml                    Route definitions (8 URLs)
│
└── sql/
    ├── auto_install.sql                  Creates correction_log table
    └── auto_uninstall.sql                Drops correction_log table
```
